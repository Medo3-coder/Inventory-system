...
<body id="page-top">
  ...
  <div id="wrapper">
    <!-- Sidebar -->     {{-- v-show to display without loading rendered and remain in the DOM  --}}
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="https://indrijunanda.gitlab.io/" target="_blank">Inventory Project</a></b>
            </span>
          </div>
        </div>
      </footer>
