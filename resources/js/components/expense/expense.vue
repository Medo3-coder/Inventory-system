...
<script type="text/javascript">
  ...
  export default {
    ...
    computed:{
      ...
      return this.expenses.filter(expense => {
         return expense.expense_date.match(this.searchTerm)              // sreach by date
      })
      }
    },
  ...
  methods:{
    allExpanse(){
      axios.get('/api/expense/')   // hit index func and return data
              ...
              if (result.value) {
               ...
               .then(() => {
                this.expenses = this.expenses.filter(expense => {
                  return expense.id != id         // to return the page without loading
                })
               })
               .catch(() => {
