...
<script type="text/javascript">
  ...
  export default {
    ...
    computed:{
      ...
      return this.categories.filter(category => {
         return category.category_name.match(this.searchTerm)              // sreach by name
      })
      }
    },
  ...
  methods:{
    allCategory(){
      axios.get('/api/category/')   // hit index func and return data
              ...
              if (result.value) {
               ...
               .then(() => {
                this.categories = this.categories.filter(category => {
                  return category.id != id         // to return the page without loading
                })
               })
               .catch(() => {
