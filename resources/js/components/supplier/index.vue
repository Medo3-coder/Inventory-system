...
<script type="text/javascript">
  ...
  export default {
    ...
    computed:{
      ...
      return this.suppliers.filter(supplier => {
         return supplier.name.match(this.searchTerm)              // sreach by name
      })
      }
    },
  ...
  methods:{
    allSupplier(){
      axios.get('/api/supplier/')   // hit index func and return data
              ...
              if (result.value) {
               ...
               .then(() => {
                this.suppliers = this.suppliers.filter(supplier => {
                  return supplier.id != id         // to return the page without loading
                })
               })
               .catch(() => {
