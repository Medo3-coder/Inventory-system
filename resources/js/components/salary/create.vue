...
<div class="form-row">
 ...
 <input type="number" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Sallary " v-model="form.sallery" >
 <small class="text-danger" v-if="errors.salary_month"> {{ errors.sallery[0] }} </small>
