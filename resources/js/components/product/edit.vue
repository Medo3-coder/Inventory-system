    ...
    <div class="row justify-content-center">
     ...
     <div class="col-md-6">
      <label for="exampleFormControlSelect1">Product Code</label>
         <input type="number" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Product Code" v-model="form.product_code">
 ...
 <div class="col-md-4">
     ...
     <div class="col-md-4">
      <label for="exampleFormControlSelect1">Selling Price</label>
         <input type="number" class="form-control" id="exampleInputFirstName" v-model="form.selling_price">
